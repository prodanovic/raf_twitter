...
public class FrogRiverOne {
    ...
    public static void main(String[] args) {
        ...
        int[] niz = {1,3,1,4,2,3,5,4};
//        System.out.println(frogRiverOne.solution(5, niz));

//        System.out.println(frogRiverOne.solution(6, niz));

        int[] niz2 = {1};
        System.out.println(frogRiverOne.solution(1, niz2));
    }
}
